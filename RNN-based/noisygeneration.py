...
class PaMPS():
    def __init__(self, POVM='Tetra',Number_qubits=4,MPS='GHZ',p=0.0):
...
if __name__ == '__main__':
    sampler = PaMPS(POVM='Tetra',Number_qubits=args.N,MPS=args.state,p=0.0)
    sampler.samples(Ns = args.Ns)
